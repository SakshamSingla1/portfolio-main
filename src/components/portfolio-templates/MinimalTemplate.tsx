...
import MinimalHero from "../templates/hero/MinimalHero";
...
/** "Minimal" shell: centered typography-first hero, no background effects
 * (no grid/mouse glow), tighter vertical rhythm, and a plain hairline
 * divider between sections instead of Classic's larger gaps. */
const MinimalTemplate = ({
  ...
  const divider = <div style={{ height: 1, background: colors.neutral800, maxWidth: 1100, margin: "0 auto" }} />;
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden" style={{ background: colors.neutral900, color: colors.neutral100 }}>
      ...
      <ErrorBoundary fallback={null} key="hero">
        <MinimalHero profile={profile} socialLinks={activeSocialLinks} />
      </ErrorBoundary>
        ...
        <Suspense fallback={null}>
          ...
          {visibleSections.services && (
            <ErrorBoundary fallback={null} key="services">
              <div className="py-14"><ServicesSection services={data.services} /></div>
              {divider}
            </ErrorBoundary>
          )}
          ...
          {visibleSections.skills && (
            <ErrorBoundary fallback={null} key="skills">
              <div className="py-14"><SkillsSection skills={data.skills} /></div>
              {divider}
            </ErrorBoundary>
          )}
          ...
          {visibleSections.experience && (
            <ErrorBoundary fallback={null} key="experience">
              <div className="py-14"><ExperienceSection experiences={data.experiences} /></div>
              {divider}
            </ErrorBoundary>
          )}
          ...
          {visibleSections.projects && (
            <ErrorBoundary fallback={null} key="projects">
              <div className="py-14"><ProjectsSection projects={data.projects} /></div>
              {divider}
            </ErrorBoundary>
          )}
          ...
          {visibleSections.achievements && (
            <ErrorBoundary fallback={null} key="achievements">
              <div className="py-14"><AchievementsSection achievements={activeAchievements} /></div>
              {divider}
            </ErrorBoundary>
          )}
          ...
          {visibleSections.certifications && (
            <ErrorBoundary fallback={null} key="certifications">
              <div className="py-14"><CertificationsSection certifications={activeCertifications} /></div>
              {divider}
            </ErrorBoundary>
          )}
          ...
          {visibleSections.education && (
            <ErrorBoundary fallback={null} key="education">
              <div className="py-14"><EducationSection educations={data.educations} /></div>
              {divider}
            </ErrorBoundary>
          )}
          ...
          {visibleSections.testimonials && (
            <ErrorBoundary fallback={null} key="testimonials">
              <div className="py-14"><TestimonialsSection testimonials={activeTestimonials} /></div>
              {divider}
            </ErrorBoundary>
          )}
          ...
          {visibleSections.languages && (
            <ErrorBoundary fallback={null} key="languages">
              <div className="py-14"><LanguagesSection languages={data.languages} /></div>
              {divider}
            </ErrorBoundary>
          )}
          ...
          {visibleSections.publications && (
            <ErrorBoundary fallback={null} key="publications">
              <div className="py-14"><PublicationsSection publications={data.publications} /></div>
              {divider}
            </ErrorBoundary>
          )}
          ...
          {visibleSections.github && data.githubStats && (
            <ErrorBoundary fallback={null} key="open-source">
              <div className="py-14"><GitHubSection githubStats={data.githubStats} githubRepos={data.githubRepos ?? []} /></div>
              {divider}
            </ErrorBoundary>
          )}

          <ErrorBoundary fallback={null} key="contact">
            <div className="py-20 mb-16"><ContactSection profile={profile} /></div>
          </ErrorBoundary>
        </Suspense>
      </main>
